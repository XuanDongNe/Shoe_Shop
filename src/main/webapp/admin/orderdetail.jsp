<%@page import="bean.OrderDetailDto"%>
				...
				<table class="table table-striped table-hover"
					...
					<thead>
						<tr>
							...
							<th>Price</th>
							<th>Quantity</th>
							<th style="width: 255px">Net Amount</th>
						</tr>
					</thead>
					<tbody>
						<c:forEach items="${listDetail}" var="d">
							<%
							OrderDetailDto orderDetail = (OrderDetailDto) pageContext.getAttribute("d");
							int price = (int) orderDetail.getPrice();
							int totalPrice = (int) orderDetail.getTotal_price();
							DecimalFormat formatter = new DecimalFormat("###,###,###");
							%>

							<tr>
								<td style="width: 180px">${d.product_name}</td>
								<td><img class="img-fluid" src="${d.image}"
