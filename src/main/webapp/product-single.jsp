...
<body class="goto-here">
		...
		<div class="container">
			<div
				...
				<div class="col-md-9 ftco-animate text-center">
					<p class="breadcrumbs">
						<span class="mr-2"><a href="home.jsp">Home</a></span> <span
							class="mr-2"><a href="shop">Shop</a></span>
					</p>
			...
			<div class="row">
				...
				<div class="col-lg-6 mb-5 ftco-animate">
					...
					<a href="images/product-1.png" class="image-popup prod-img-bg"><img
						src="${detail.pImage }" class="img-fluid" alt="Colorlib Template"></a>
				</div>
				<div class="col-lg-6 product-details pl-md-5 ftco-animate">
					...
					<p>
						<a href="#" class="btn btn-black py-3 px-5 mr-2"
							onclick="addToCart()">Add to Cart</a> </a> <a
							href="#" onclick="buyNow()"
	...
	<script>
		function addToCart() {
			...
			var cartUrl = '${pageContext.request.contextPath}/addToCart?pId=${detail.pId}&quantity='
					+ quantity + '&price=${detail.price}' + '&isShop=false';
	...
	<script>
		function buyNow() {
			...
			console.log("detail.pId: ${detail.pId}");
			var quantity = document.getElementById('quantity').value;
			var cartUrl = '${pageContext.request.contextPath}/buyForward?pId=${detail.pId}&quantity='
					+ quantity + '&price=${detail.price}' ;
