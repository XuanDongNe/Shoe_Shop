...
<body class="goto-here">
	...
	<section class="ftco-section bg-light">
		...
		<div class="container">
			<div class="row">
				<c:forEach items="${listPLimit}" var="p">
					<%
					...
					<div class="col-sm-12 col-md-6 col-lg-3 ftco-animate d-flex">
						<div class="product d-flex flex-column">
							<a href="singleProduct?pId=${p.pId}" class="img-prod"><img class="img-fluid"
								src="${p.pImage}" alt="Colorlib Template">
							...
							<div class="text py-3 pb-4 px-3">
								...
								<p class="bottom-area d-flex px-3">
									<a href="addToCart?pId=${p.pId}&quantity=1&price=${p.price}&isShop=true" class="add-to-cart text-center py-2 mr-1"><span>Add
											to cart <i class="ion-ios-add ml-1"></i>
									</span></a> <a href="buyForward?pId=${p.pId}&quantity=1&price=${p.price}&buyNow=true" class="buy-now text-center py-2">Buy now<span><i
				...
				<div class="col-md-6">
					...
					<div class="text-deal">
						...
						<ul class="thumb-deal d-flex mt-4">
							<li class="img"
								style="background-image: url(images/product-6.png);"></li>
							<li class="img"
								style="background-image: url(images/product-2.png);"></li>
							<li class="img"
								style="background-image: url(images/product-4.png);"></li>
						</ul>
					</div>
				</div>
			</div>
					...
					<div class="carousel-testimony owl-carousel">
						<div class="item">
							<div class="testimony-wrap">
								...
								<div class="text">
									<p class="mb-4 pl-4 line">Far far away, behind the word
