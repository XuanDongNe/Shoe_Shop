		...
		<div class="container">
			<div
				...
				<div class="col-md-9 ftco-animate text-center">
					<p class="breadcrumbs">
						<span class="mr-2"><a href="home">Home</a></span> <span>Checkout</span>
					</p>
					...
					<div class="row mt-5 pt-3 d-flex">
						<div class="col-md-6 d-flex">
							<div class="cart-detail cart-total bg-light p-3 p-md-4">
								...
								<p class="d-flex">
									<span>Subtotal</span><%=formatter.format(totalPrice)%>&nbsp; <span>₫</span>
								</p>
								<p class="d-flex">
								...
								<p class="d-flex total-price">
									<span>Total</span><%=formatter.format(totalPrice)%>&nbsp; <span>₫</span>
								</p>
							</div>
						</div>
						<div class="col-md-6">
							<div class="cart-detail bg-light p-3 p-md-4">
								...
								<p>
									<a
										href="orderForward?buyNow=${isBuyNow}&price=${price}&quantity=${quantity}&pId=${pId}"
